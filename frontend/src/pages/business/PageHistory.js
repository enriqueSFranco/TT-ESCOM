    ...
    <section className={styles.wrapper}>
      ...
      <aside className={styles.sidebar}>
        <nav className={styles.menu}>
          <ul>
            <li className={styles.itemAvatar}><Avatar sx={{ bgcolor: deepPurple[500] }}>E</Avatar>Enrique</li>
            ...
            <li><Link to="publicar-vacante">Publicar vacante</Link></li>
            <li><Link to="/"><IoMdLogOut />Cerrar sesion</Link></li>
          </ul>
        </nav>
      </aside>
