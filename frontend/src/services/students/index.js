...
export const uploadCVStudent = (id, payload) => {
  ...
  return API.put(`${RACT_APP_URL_CANDIDATE_UPLOAD_CV}${id}/`, payload)
    .then((response) => {
      const { data } = response;
      return data;
    })
