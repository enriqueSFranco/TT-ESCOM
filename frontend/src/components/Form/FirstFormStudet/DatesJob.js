          ...
          <form>
            ...
            <div className={styles.conCheckbox}>
              ...
              <div className={styles.checkbox}>
                <CheckboxComponent htmlFor="name" label="Hibrido"/>
                <CheckboxComponent htmlFor="name" label="Presencial"/>
                <CheckboxComponent htmlFor="name" label="Home Office"/>
              </div>
            </div>
            ...
            <div className={styles.softskills}>
                <div className={styles.autocomplete}>
                  <Autocomplete
                    ...
                    options={top100Films}
                    sx={{ width: 460 }}
                    renderInput={(params) => <TextField {...params} label="Hard Skills" />}
                    value={value}
                    onChange={(event, newValue) => {
                      setValue(newValue);
                    }}
