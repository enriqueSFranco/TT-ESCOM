...
\begin{UCtrayectoria}
	\UCpaso [\UCactor] Presiona el ícono \IUAgregar{} en la sección ``Experiencia laboral'' en la interfaz \refIdElem{USR-IU02}.
	\UCpaso Muestra la interfaz \refIdElem{USR-IU02.5a}.
	\UCpaso [\UCsist] \label{USRCU02-5} Selecciona el tipo de experiencia que requiera ``Proyecto'' o ``Laboral''.
