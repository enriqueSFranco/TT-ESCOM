...
\begin{UCtrayectoria}
    ...
    \UCpaso [\UCsist] Muestra la información obtenida en interfaz \refElem{ADMN-IU02}.\refTray{A}\refTray{B}\refTray{C}
...
%Trayectorias Alternativas
\begin{UCtrayectoriaA}[Fin de la trayectoria]{B}{El actor desea editar la información de  un coloborador.}
	\UCpaso [\UCactor] Da clic en el ícono \IUEditar{}.
	\extendUC{ADMN-CU02.3}.
\end{UCtrayectoriaA} 

%Trayectorias Alternativas
\begin{UCtrayectoriaA}[Fin de la trayectoria]{C}{El actor desea eliminar un coloborador.}
