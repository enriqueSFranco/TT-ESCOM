...
\begin{UCtrayectoria}
	\UCpaso [\UCactor] Presiona el ícono \IUEditar{} en la sección ``Objetivos profesionales'' en la interfaz \refIdElem{USR-IU02}. 
	\UCpaso Obtiene el objetivo, el salario deseado y el trabajo deseado que se tiene registrados actualmente en el sistema.
	\UCpaso [\UCsist] Muestra la información obtenida en la interfaz \refIdElem{USR-IU02.4}.
