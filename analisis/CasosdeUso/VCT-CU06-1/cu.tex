\begin{UseCase}[]{VCT-CU06-1}{Consultar vacante}{
...
\begin{UCtrayectoria}
	\UCpaso [\UCactor] Seleciona una vacante desde la interfaz \refElem{VCT-IU06}.
	...
	\UCpaso [\UCsist] Muestra la información optenida en el componente \refElem{VCT-IU06-3} en el lado izquierdo de la interfaz \refElem{VCT-IU06}
\end{UCtrayectoria}
