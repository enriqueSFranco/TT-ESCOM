...
En la figura \refElem{VCT-IU06} se muestra la interfaz correspondiente con la funcionalidad descrita en las
trayectorias del caso de uso \refElem{VCT-CU06} , la cual permite al actor registrado o no dentro del sistema consultar 
...
\begin{itemize}
   ...
   la interfaz \refIdElem{VCT-IU06-3}.
\end{itemize}

\IUfig{.9}{analisisydiseno/CasosdeUso/VCT-CU06/imagenes/GRL-IU06.png}{VCT-IU06}{Listar vacantes} 
...
\IUfig{.9}{analisisydiseno/CasosdeUso/VCT-CU06/imagenes/GRL-IU06-3.png}{VCT-IU06-3}{Consulta de una vacante} 
