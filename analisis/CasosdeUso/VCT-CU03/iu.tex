...
Cada vacante listada se muestra por un componente llamando ``contenedor'' el cual se puede ver en la figura \refElem{VCT-IU03a}, la informacion que 
...
Cada vacante al selecionarla para su consulta se muestra por un componente llamando ``card'' el cual se puede ver en la figura \refElem{VCT-IU03b}, la informacion que 
muestra es la sigueinte: 
\begin{itemize}
   \item Titulo de la vacante (1).
