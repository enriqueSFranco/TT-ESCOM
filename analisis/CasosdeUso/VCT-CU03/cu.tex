...
\begin{UCtrayectoria}
	\UCpaso [\UCactor] Da clic en el botón \IUbutton{Vacantes} en la interfaz de incio del reclutador
	\UCpaso [\UCsist] Verifica que el usuario tenga almenos una vacante registrada en el sistema.%\refTray{A}
	...
	\UCpaso [\UCsist] Muestra la información obtenida en la intefaz \refElem{VCT-IU03}. \refTray{A}
\end{UCtrayectoria}
