...
\begin{UCtrayectoria}
	\UCpaso [\UCactor] Presiona el botón \IUbutton{Iniciar sesión} desde la interfaz \refElem{GRL-IU00}.\refTray{A}
    \UCpaso [\UCsist] Muestra la interfaz \refElem{GRL-IU03}.
	\UCpaso [\UCactor] Ingresa el \entrada[correo electrónico]{users.email} y \entrada[contraseña]{users.password}.\label{cu03-grl1}\refTray{A}
