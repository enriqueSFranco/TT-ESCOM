...
\begin{UCtrayectoria}
	\UCpaso [\UCactor] Presiona el botón \IUbutton{Iniciar sesión} desde la interfaz \refElem{VCT-IU01}.\refTray{A}
    \UCpaso [\UCsist] Muestra la interfaz \refElem{GRL-IU03}.
	\UCpaso [\UCactor] Ingresa el correo electrónico y contraseña.\label{cu03-grl1}\refTray{A}
    ...
    \UCpaso [\UCsist] Muestra la interfaz \refElem{USR-IU02}.\refTray{G} %\refTray{H}
\end{UCtrayectoria}
...
\begin{UCtrayectoriaA}[Fin del caso de uso]{F}{El actor inicia sesión por primera vez.}
	\UCpaso [\UCsist] Muestra la interfaz \refIdElem{USR-IU01}.
	\extendUC{USR-CU01}.
\end{UCtrayectoriaA} 
...
\UCExtensionPoint{Enviar preregistro}{El actor requiere registrarse en el sistema}{En el paso  de la trayectoria alternativa C}{\refIdElem{GRL-CU02}}
\UCExtensionPoint{Crear perfil}{El actor inicia sesión por primera vez en el sistema}{En el paso  de la trayectoria alternativa C}{\refIdElem{USR-CU01}}
