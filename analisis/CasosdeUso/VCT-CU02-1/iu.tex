...
\IUfig{.9}{CasosdeUso/VCT-CU02/imagenes/VCT-IU02-2.png}{VCT-IU02}{Listar vacantes} 

\subsubsection{Consulta de vacante}
Cada vacante al ser seleccionada para su consulta se muestra por un componente llamando ``card'' el cual se puede ver en la figura \refElem{GRL-IU02-2}, la información que 
...
\IUfig{.9}{CasosdeUso/VCT-CU02/imagenes/VCT-IU02-3.png}{VCT-IU02.3}{Consulta de una vacante} 
