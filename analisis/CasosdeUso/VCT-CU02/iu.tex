...
trayectorias del caso de uso \refElem{VCT-CU02} , la cual permite al actor registrado o no dentro del sistema consultar 
las vacantes publicadas.

La interfaz \refElem{VCT-IU01} esta dividida en dos ``secciones'':
\begin{itemize}
   ...
   la interfaz \refIdElem{VCT-IU02}.
\end{itemize}
\IUfig{.9}{CasosdeUso/VCT-CU02/imagenes/VCT-IU02-2.png}{VCT-IU02}{Card de una vacante} 
\subsubsection{Listado de vacantes}
Cada vacante listada se muestra por un componente llamando ``contenedor'' el cual se puede ver en la figura \refElem{VCT-IU02-1}, la información que 
...
\IUfig{.9}{CasosdeUso/VCT-CU02/imagenes/VCT-IU02-3.png}{VCT-IU02-1}{Card de una vacante} 
...
\IUfig{.9}{CasosdeUso/VCT-CU02/imagenes/VCT-IU02-2.png}{VCT-IU02-2}{Listar vacantes} 
