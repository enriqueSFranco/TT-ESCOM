\begin{UseCase}[]{USR-CU04.1}{Agregar Certificaciones o cursos}{
	...
	\UCitem{Destino}{
		\Titem \refElem{USR-IU06.1}
	}
	\UCitem{Viene de}{
		Caso de uso \refIdElem{USR-CU06}.
	}	
\end{UseCase}

%Trayectoria Principal
\begin{UCtrayectoria}
	\UCpaso [\UCactor] Presiona el ícono \IUAgregar{} en la interfaz \refIdElem{USR-IU6}.
	\UCpaso Muestra la interfaz \refIdElem{USR-IU6.1}.
