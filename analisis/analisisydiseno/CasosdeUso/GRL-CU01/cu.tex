\begin{UseCase}{GRL-CU01}{Crear Cuenta}{
	...
	\UCitem{Postcondiciones}{
		El actor podrá gestionar su perfil y aplicar a las vacantes publicadas en el sistema.
	}
	\UCitem{Entradas}{
		\imprimeUC{entrada}
	}
...
\begin{UCtrayectoria}
	\UCpaso [\UCactor] Presiona el botón \IUbutton{Crea tu cuenta} desde la interfaz \refElem{GRL-IU06}.
    ...
    \UCpaso [\UCsist] Muestra la interfaz \refElem{GRL-IU06}..
\end{UCtrayectoria}

%Trayectorias Alternativas
\begin{UCtrayectoriaA}[Fin de la trayectoria]{A}{El actor decide cancelar el registro de un usuario.}
