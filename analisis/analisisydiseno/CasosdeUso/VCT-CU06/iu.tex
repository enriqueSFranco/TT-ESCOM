...
En la figura \refElem{GRL-IU06} se muestra la interfaz correspondiente con la funcionalidad descrita en las
...
\begin{itemize}
   ...
   la interfaz \refIdElem{GRL-IU06-1}.
\end{itemize}

\IUfig{.9}{analisisydiseno/CasosdeUso/VCT-CU06/imagenes/GRL-IU06.png}{GRL-IU06}{Listar vacantes} 

\subsubsection{Listado de vacantes}
Cada vacante listada se muestra por un componente llamando ``card'' el cual se puede ver en la figura \refElem{GRL-IU06-2}, la informacion que 
...
\IUfig{.9}{analisisydiseno/CasosdeUso/VCT-CU06/imagenes/GRL-IU06-2.png}{GRL-IU06-2}{Card de una vacante} 
...
\IUfig{.9}{analisisydiseno/CasosdeUso/VCT-CU06/imagenes/GRL-IU06-1.png}{GRL-IU06-1}{Listar vacantes} 
