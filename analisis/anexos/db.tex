...
\begin{cdtEntidad}{t300_empresa}{Empresa}{
    %Es un periodo de tiempo, generalmente de 12 meses donde las Alcaldías, Dependencias, Órganos Desconcentrados y Entidades, cuadran las cuentas de sus actividades financieras y contables.}

	    \brAttr{t300_id_empresa}{Id}{tInt}{
	        %Es el correo del alumno con el cual se identificara como unico dentro del sistema.
	        %Restricciones adicionales:
            \begin{Citemize}
                \item \refElem{tPrimaryKey}
        ...
        \brAttr{t300_nombre}{Nombre}{tVarchar}{
	        %Es el correo del alumno con el cual se identificara como unico dentro del sistema.
        }{\datRequerido}

        \brAttr{t300_rfc}{RFC}{tVarchar}{
	        %Es el correo del alumno con el cual se identificara como unico dentro del sistema.
	        %Restricciones adicionales:
            %\begin{Citemize}
            %    \item \refElem{tUnico}
        ...
        \brAttr{t300_nss}{Número de seguro social }{tInt}{
	   %     Es el correo del alumno con el cual se identificara como unico dentro del sistema.
	   %     Restricciones adicionales:
       %     \begin{Citemize}
       %         \item \refElem{tPrimaryKey}
       ...
       %     \end{Citemize}
        ...
        \brAttr{t300_page_web}{Página Web}{tVarchar}{
	   %     Es el correo del alumno con el cual se identificara como unico dentro del sistema.
	   %     Restricciones adicionales:
       %     \begin{Citemize}
       %         \item \refElem{tPrimaryKey}
       ...
       %     \end{Citemize}
        ...
        \brAttr{t300_mision}{Misión}{tVarchar}{
	   %     Es el correo del alumno con el cual se identificara como unico dentro del sistema.
	   %     Restricciones adicionales:
       %     \begin{Citemize}
       %         \item \refElem{tPrimaryKey}
       ...
       %     \end{Citemize}
        ...
        \brAttr{t300_vision}{Vision}{tVarchar}{
	   %     Es el correo del alumno con el cual se identificara como unico dentro del sistema.
	   %     Restricciones adicionales:
       %     \begin{Citemize}
       %         \item \refElem{tPrimaryKey}
      %          \item \refElem{tUnico}
       %     \end{Citemize}
        ...
        \brAttr{t300_razon_social}{Razon Social}{tVarchar}{
	   %     Es el correo del alumno con el cual se identificara como unico dentro del sistema.
	   %     Restricciones adicionales:
       %     \begin{Citemize}
       %         \item \refElem{tPrimaryKey}
      %          \item \refElem{tUnico}
       %     \end{Citemize}
        ...
        \brAttr{t300_fecha_alta}{Fecha de alta}{tDate}{
	   %     Es el correo del alumno con el cual se identificara como unico dentro del sistema.
	   %     Restricciones adicionales:
       %     \begin{Citemize}
       %         \item \refElem{tPrimaryKey}
       ...
       %     \end{Citemize}
        ...
        \brAttr{t400_id_admin}{Id del administrador}{tVarchar}{
	   %     Es el correo del alumno con el cual se identificara como unico dentro del sistema.
	   %     Restricciones adicionales:
            \begin{Citemize}
...
\begin{cdtEntidad}{t301_reclutador}{Reclutador}{
    %Es un periodo de tiempo, generalmente de 12 meses donde las Alcaldías, Dependencias, Órganos Desconcentrados y Entidades, cuadran las cuentas de sus actividades financieras y contables.}

	    \brAttr{t301_id_reclutador}{Id}{tInt}{
	        %Es el correo del alumno con el cual se identificara como unico dentro del sistema.
	        %Restricciones adicionales:
            \begin{Citemize}
                \item \refElem{tPrimaryKey}
        ...
        \brAttr{t301_nombre}{Nombre}{tVarchar}{
	        %Es el correo del alumno con el cual se identificara como unico dentro del sistema.
        }{\datRequerido}

        \brAttr{t301_paterno}{Apellido Paterno}{tVarchar}{
	        %Es el correo del alumno con el cual se identificara como unico dentro del sistema.
	        %Restricciones adicionales:
            %\begin{Citemize}
            %    \item \refElem{tUnico}
        ...
        \brAttr{t301_materno}{Apellido Materno}{tVarchar}{
	        %Es el correo del alumno con el cual se identificara como unico dentro del sistema.
	        %Restricciones adicionales:
            %\begin{Citemize}
            %    \item \refElem{tUnico}
       ...
       % \brAttr{t301_usuario}{Número de seguro social }{tInt}{
	   %     Es el correo del alumno con el cual se identificara como unico dentro del sistema.
	   %     Restricciones adicionales:
       %     \begin{Citemize}
       %         \item \refElem{tPrimaryKey}
