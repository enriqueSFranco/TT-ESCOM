...
\begin{BusinessRule}[]{RN-N002}{Formato válido para el correo electrónico}
	...
	\BRitem{Sentencia}{%
		...
		$\hat{}$(w+[/./-]?){1,}@[A-Za-z]+[/.]\textbackslash{}w{2,}\$
	}
	\BRitem{Ejemplo}{%
...
%-----------------------BR-005---------------------------
\begin{BusinessRule}[]{RN-N005}{Formato válido para del RFC}
	\BRsection[control]{Atributos}%
	\BRitem[admin]{Clase}{\bcIntegridad}%
	\BRitem{Descripción}{%
	...
	\BRitem{Sentencia}{%
		...
		$\hat{}$([A-ZÑ\textbackslash{}x26]{3,4})([0-9]{6})([A-Z0-9]{3})\$
	}
	%\BRitem{Ejemplo}{%
...
%-----------------------BR-006---------------------------
\begin{BusinessRule}[]{RN-N006}{Formato válido para de la contraseña}
	\BRsection[control]{Atributos}%
	\BRitem[admin]{Clase}{\bcIntegridad}%
	\BRitem{Descripción}{%
	...
	\BRitem{Sentencia}{%
		...
		$\hat{}$(?=.[a-z])(?=.[A-Z])(?=.\textbackslash{}d)(?=.[\$@\$!\%?\&])([A-Za-z\textbackslash{}d\$@\$!\%?\&]|[$\hat{}$ ]){8,15}\$
	}
	%\BRitem{Ejemplo}{%
