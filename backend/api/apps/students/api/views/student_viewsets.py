	...
	def get_object(self, pk):
		if self.queryset is None:
			self.queryset = self.model.objects\
				.filter(pk=pk)\
				.values('t100_boleta','t100_name','t100_last_name','t100_username','t100_password','t100_cv','t100_email','t100_gender','t100_date_of_birth','t100_personal_objectives','t100_target_salary','t100_travel','t100_profile_picture','is_active')
