...
from apps.students.api.views.studentlenguages_viewset import LanguagesViewSet
...
router.register(r'StudentsLanguages',LanguagesViewSet,basename='Students lenguages')
